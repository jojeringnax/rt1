...
## Периодичность обновления данных на карте
- php artisan organizations:fill -> заполнение происходит раз в день в час ночи;
- php artisan autocolumns:fill -> заполнение происходит раз в день в 1:10 ночи;
- php artisan spots:fill -> заполнение происходит раз в день в 1:20 ночи;
- php artisan brigades:fill -> заполнение происходит раз в день в 1:30 ночи;
- php artisan cars:fill -> заполнение происходит каждые 30 минут;
- php artisan statistics:fill -f заполнение происходит каждые 45 минут.

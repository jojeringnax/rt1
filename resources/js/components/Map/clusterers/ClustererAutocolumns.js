            ...
            if (ymaps && !this.state.template) {
                ...
                this.setState({
                    balloonContentLayout: ymaps.templateLayoutFactory.createClass([
                        ...
                        '<li><a class="link-one_point" id="'+this.props.id+'" data-id="'+ this.props.id+ '" onclick="window.onclick.autocolumn[\'{{geoObject.properties.id}}\']()"',
                        ...
                        '</div></a></li>',
                        '{% else %}',
                        '<li><a class="link-one_point" data-id="'+ this.props.id+ '" onclick="window.onclick.autocolumn[\'{{geoObject.properties.id}}\']()"',
                        ' href=# class="list_item car-baloon">',
